...
namespace SpurRoguelike.ConsoleGUI {
    internal class ConsoleGui : IClickHandler {
        ...
        public void EndGame(Boolean isCompleted) {
        ...
        public void HandleMouseClick(Int32 mouseLeft, Int32 mouseTop) {
            MoveCursorAbsolute(mouseLeft, mouseTop);
        }

        private void LayoutScreen() {
            var levelBlockHeight = (Int32)(screen.Height * 0.8);
            var levelBlockWidth = (Int32)(screen.Width * 0.6);
            var statsBlockHeight = (Int32)(levelBlockHeight * 0.6);
        ...
        private void MoveCursor(Int32 leftDelta, Int32 topDelta) {
            MoveCursorAbsolute(cursorLeft + leftDelta, cursorTop + topDelta);
        }

        private void MoveCursorAbsolute(Int32 left, Int32 top) {
        ...
        private Int32 cursorLeft;
        private Int32 cursorTop;
